...
- (void)initializer
{
    ...
    for (NSUInteger i = 0; i < 2; ++i)
    {
        ...
        [self addConstraints:@[
                               ...
                               [NSLayoutConstraint constraintWithItem:buttonView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeHeight multiplier:1.0 constant:-11]
                               ]];
    }
}
